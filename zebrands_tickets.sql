...
--
-- Servidor: localhost
-- Tiempo de generación: 27-04-2022 a las 02:30:52
...
INSERT INTO `categoria` (`ID_categoria`, `nombre_categoria`, `tiempo_estimado`, `disponible`) VALUES
(1, 'Orden no avanza de status', 10, 1),
(2, 'Error en nota de Crédito', 5, 1),
(3, 'Crear acceso', 1, 1),
(4, 'Error de entrega', 11, 1),
(5, 'Error en CRM', 3, 1),
(6, 'Error en Pago', 2, 1),
(7, 'Error de retorno', 7, 1),
(8, 'Cambio de domicilio', 4, 1);
...
INSERT INTO `pregunta` (`ID_pregunta`, `ID_categoria`, `texto_pregunta`, `disponible`) VALUES
(7, 7, 'Cual es el código de confirmación de tu pedido?', 1),
(8, 7, 'Que paquetería te entregó el producto?', 1),
(9, 8, 'Cual es tu usuario?', 1),
(10, 8, 'Que problema te presenta el sistema?', 1),
(11, 8, 'El domicilio nuevo es dentro del mismo país que el actual?', 1),
(12, 6, 'En que parte del pago se presenta el error?', 1),
(13, 1, 'Cual es el ID de tu orden?', 1),
(14, 1, 'Hace cuanto no avanza de status?', 1),
(15, 2, 'En que momento en específico se presenta el error?', 1),
(16, 2, 'por favor, ingresa el texto del error que te aparece en pantalla', 1),
(17, 3, 'Que sucede al intentar crear acceso?', 1),
(18, 4, 'El cliente recibió un producto diferente a lo que solicitó?', 1),
(19, 4, 'El paquete llegó incompleto?', 1),
(20, 4, 'El cliente recibió un paquete de alguien más?', 1),
(21, 5, 'Podrías pegar el texto del error que te muestra la interfaz?', 1);
...
(71, 7, 42, 'WE18435'),
(72, 8, 42, 'DHL'),
(73, 10, 43, '\"por el momento, no es posible hacer cambios en el domicilio registrado a su cuenta\"'),
(74, 11, 43, 'Sí'),
(75, 9, 43, 'jose123'),
(76, 17, 44, 'Me arroja un error '),
(77, 17, 45, 'El sistema me arroja un error'),
(78, 16, 46, 'error'),
(79, 15, 46, 'mañana'),
(80, 17, 47, 'Me marca error'),
(81, 17, 49, 'problema'),
(82, 17, 50, 'Error '),
(83, 17, 51, 'De la vista ticketstotal'),
(84, 17, 52, 'Problema');
...
CREATE TABLE `resuelve_ticket` (
  ...
  `comentarios_solucion` varchar(1000) COLLATE utf8_spanish2_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci;
...
(6, 2, '2022-03-30', '2022-03-31', 'En proceso de solución'),
(7, 3, '2022-03-30', '2022-04-08', 'En proceso de solución'),
(8, 3, '2022-03-30', '2022-04-01', 'En espera de confirmación'),
(9, 4, '2022-03-30', '2022-04-09', 'Esperando confirmación'),
(10, 3, '2022-03-30', '2022-04-03', 'Delegado por el momento'),
(11, 4, '2022-03-30', '2022-03-31', 'Esperando datos'),
(12, 1, '2022-03-28', '2022-04-15', 'Problema solucionado directo con la paquetería'),
(13, 1, '2022-03-16', '2022-04-18', 'Tuve que cambiarlo directamente en la base de datos'),
(14, 1, '2022-03-31', '2022-04-16', 'Prueba de comentario'),
(15, 2, '2022-03-26', '2022-04-09', 'Directamente con el banco'),
(16, 1, '2022-03-27', '2022-04-01', 'Correo duplicado. Se le indicaron al cliente una serie de pasos para que recuperara su contraseña '),
(17, 4, '2022-04-01', '2022-04-08', 'Directamente con FedEx'),
(18, 3, '2022-03-19', '2022-04-14', 'CRM corregido directo en la base de datos'),
...
(6, 1, 3, 3, 'Orden no cambia de estado', 'Han pasado 5 días desde que no noto ningun cambio'),
...
(10, 5, 6, 5, 'Problema con CRM', 'Los datos no parecen ser los correctos, se pide una actualización de los mismos'),
...
(14, 1, 4, 4, 'Orden sigue en el mismo estado', 'No se ha actualizado en unos cuantos días'),
...
(42, 7, 1, 1, 'Retorno', 'Tuve un error al intentar regresar mi almohada'),
(43, 8, 1, 1, 'Domicilio erroneo', 'Quiero cambiar mi domicilio, pero el sistema no me lo permite'),
...
--
DELIMITER $$
CREATE TRIGGER `AfterInsertTicket` AFTER INSERT ON `ticket` FOR EACH ROW INSERT into resuelve_ticket VALUES (NEW.ID_ticket, NULL, NULL, NULL, NULL)
$$
DELIMITER ;
...
CREATE TABLE `usuario` (
  ...
  `apellido_paterno` varchar(40) COLLATE utf8_spanish2_ci DEFAULT NULL,
  `apellido_materno` varchar(40) COLLATE utf8_spanish2_ci DEFAULT NULL,
...
--
ALTER TABLE `respuesta`
  MODIFY `ID_respuesta` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=85;
...
--
ALTER TABLE `ticket`
  MODIFY `ID_ticket` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=53;
