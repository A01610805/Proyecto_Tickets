...
--
-- Servidor: localhost
-- Tiempo de generación: 15-04-2022 a las 21:19:41
...
(7, 3, '2022-03-30', '2022-03-31', 'En proceso de solución'),
...
--
ALTER TABLE `respuesta`
  MODIFY `ID_respuesta` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=68;
...
--
ALTER TABLE `ticket`
  MODIFY `ID_ticket` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
